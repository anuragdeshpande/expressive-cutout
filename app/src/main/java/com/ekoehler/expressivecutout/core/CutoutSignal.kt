...
enum class SystemEventType(
    ...
    ADB_CONNECTED(Icons.Rounded.Adb, R.string.event_adb_connected, 0xFF4ADE80, R.string.event_tab_connected),
    ADB_DISCONNECTED(Icons.Rounded.Adb, R.string.event_adb_disconnected, 0xFFF87171, R.string.event_tab_disconnected),
    WIRELESS_DEBUGGING_CONNECTED(Icons.Rounded.Adb, R.string.event_wireless_debugging_connected, 0xFF38BDF8, R.string.event_tab_connected),
    WIRELESS_DEBUGGING_DISCONNECTED(Icons.Rounded.Adb, R.string.event_wireless_debugging_disconnected, 0xFFF87171, R.string.event_tab_disconnected),
